        ...
        <div class="header-body text-center mb-7">
          <div class="row justify-content-center">
            <div class="col-lg-5 col-md-6">
              <h1 class="text-white">{{ $t('login.welcome') }}</h1>
              <p class="text-lead text-white">{{ $t('login.slogan') }}</p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="row align-items-center justify-content-xl-between">
          <div class="col-xl-6">
            <div class="copyright text-center text-xl-left text-muted">
              &copy; {{year}}
              <a href="#" class="font-weight-bold ml-1" target="_blank">Mappets</a>
            </div>
          </div>
          <div class="col-xl-6">
            <ul class="nav nav-footer justify-content-center justify-content-xl-end">
              <li class="nav-item">
                <a href="#" class="nav-link" target="_blank">Mappets</a>
              </li>
              <li class="nav-item">
