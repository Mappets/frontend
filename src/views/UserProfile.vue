<template>
  <div>
    <base-header
      ...
      style="min-height: 600px; background-image: url(https://www.peaceofminddogrescue.org/images/misc/homepage/adopt.jpg); background-size: cover; background-position: center top;"
    >
      <!-- Mask -->
            ...
            <div class="row justify-content-center">
              <div class="col-lg-3 order-lg-2">
                <div class="card-profile-image">
                  <a href="#">
                    <img :src="model.previewImage" class="rounded-circle" />
                  </a>
                </div>
              </div>
            </div>
...
export default {
  ...
  mounted() {
    if (this.$session.has("user_id")) {
      this.model.user = this.$session.get("user_id");
      console.log(this.model.user.profile.picture);
      this.model.previewImage = this.model.user.profile.picture;
    }
  },
  methods: {
    uploadImage(e) {
