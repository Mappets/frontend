      ...
      <div class="container-fluid d-flex align-items-center">
        <div class="row">
          <div class="col-lg-12 col-md-12">
            <h1 class="display-2 text-white">{{ $t("pets.newPet") }}</h1>
          ...
          <card shadow type="secondary">
            <div slot="header" class="bg-white border-0">
              <div class="row align-items-center">
                <div class="col-12">
                  <h3 class="mb-0">{{ $t("pets.newPet") }}</h3>
                </div>
              </div>
            </div>
            <template>
              <form @submit.prevent>
                <h6 class="heading-small text-muted mb-4">{{ $t("pets.petInformation") }}</h6>
                <div class="pl-lg-4">
                  <div class="row">
                    <div class="col-lg-6">
                      <base-input
                      ...
                      <span
                        class="error"
                        v-if="!$v.model.name.minLength"
                      >{{ $t("validations.min") }}</span>
                    </div>
                    <div class="col-lg-6">
                      <base-input
                        alternative
                ...
                <div class="pl-lg-4">
                  <div class="row">
                    <div class="col-md-12">
                      <button class="btn btn-success" type="button" @click="update">Send</button>
                    </div>
                  </div>
                </div>
              </form>
